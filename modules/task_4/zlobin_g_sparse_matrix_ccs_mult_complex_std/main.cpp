...
TEST(MatrixCCSMultiplication, ThrowIfNotCorrespondingMatrices) {
    ...
    MatrixCCS B = MatrixCCS(2, 4,
        ...
        {7, 0}, {0, 0},
        {0, -10}, {20, 0} });
    ASSERT_ANY_THROW(STDMultiplication(A, B));
}
...
TEST(MatrixCCSMultiplication, CanMultiplyCorrespondingMatrices) {
    ...
    MatrixCCS B = MatrixCCS(2, 3,
        ...
        {2, 3}, {-7, 0},
        {7, 0}, {0, 0} });
    ASSERT_NO_THROW(STDMultiplication(A, B));
}
...
TEST(MatrixCCSMultiplication, MyltiplyNumbers) {
    ...
    MatrixCCS AB = MatrixCCS(1, 1,
        { {12520, 4620} });
    ASSERT_EQ(AB, STDMultiplication(A, B));
}
...
TEST(MatrixCCSMultiplication, MyltiplyOnSingularMatrix) {
    ...
    MatrixCCS B = MatrixCCS(2, 2,
        { {3, 20}, {4, 0},
        {0, -3}, {0, 0} });
    ASSERT_EQ(B, STDMultiplication(A, B));
}
...
TEST(MatrixCCSCompareRealizations, CompareLeftRow) {
    ...
    A.FillRandom();
    B.FillRandom();
    ASSERT_EQ(SeqMultiplication(A, B), STDMultiplication(A, B));
}
...
// //     MatrixCCS A = MatrixCCS(4000, 3000, 500000);
// //     MatrixCCS B = MatrixCCS(2000, 4000, 500000);
// //     A.FillRandom();
// //     B.FillRandom();
...
//     std::cout << "[     TIME ] " << time.count() << "\tseconds\n";
// }
// TEST(MatrixCCSPerformance, STD1Thread) {
//     MatrixCCS A = MatrixCCS(4000, 4000, 1000000);
//     MatrixCCS B = MatrixCCS(4000, 4000, 1000000);
//     A.FillRandom();
//     B.FillRandom();
//     auto start = std::chrono::high_resolution_clock::now();
//     ASSERT_NO_THROW(STDMultiplication(A, B, 1));
//     auto end = std::chrono::high_resolution_clock::now();
//     std::chrono::duration<double> time = end - start;
//     std::cout << "[     TIME ] " << time.count() << "\tseconds\n";
// }
// TEST(MatrixCCSPerformance, STD2Thread) {
//     MatrixCCS A = MatrixCCS(4000, 4000, 1000000);
//     MatrixCCS B = MatrixCCS(4000, 4000, 1000000);
//     A.FillRandom();
//     B.FillRandom();
//     auto start = std::chrono::high_resolution_clock::now();
//     ASSERT_NO_THROW(STDMultiplication(A, B, 2));
//     auto end = std::chrono::high_resolution_clock::now();
//     std::chrono::duration<double> time = end - start;
//     std::cout << "[     TIME ] " << time.count() << "\tseconds\n";
// }
// TEST(MatrixCCSPerformance, STD4Thread) {
//     MatrixCCS A = MatrixCCS(4000, 4000, 1000000);
//     MatrixCCS B = MatrixCCS(4000, 4000, 1000000);
//     A.FillRandom();
//     B.FillRandom();
//     auto start = std::chrono::high_resolution_clock::now();
//     ASSERT_NO_THROW(STDMultiplication(A, B, 4));
//     auto end = std::chrono::high_resolution_clock::now();
//     std::chrono::duration<double> time = end - start;
//     std::cout << "[     TIME ] " << time.count() << "\tseconds\n";
// }
// TEST(MatrixCCSPerformance, STD9Thread) {
//     MatrixCCS A = MatrixCCS(4000, 4000, 1000000);
//     MatrixCCS B = MatrixCCS(4000, 4000, 1000000);
//     A.FillRandom();
//     B.FillRandom();
//     auto start = std::chrono::high_resolution_clock::now();
//     ASSERT_NO_THROW(STDMultiplication(A, B, 9));
//     auto end = std::chrono::high_resolution_clock::now();
//     std::chrono::duration<double> time = end - start;
//     std::cout << "[     TIME ] " << time.count() << "\tseconds\n";
// }
