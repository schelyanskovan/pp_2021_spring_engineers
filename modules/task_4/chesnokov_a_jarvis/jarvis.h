...
#ifndef MODULES_TASK_4_CHESNOKOV_A_JARVIS_JARVIS_H_
#define MODULES_TASK_4_CHESNOKOV_A_JARVIS_JARVIS_H_
...
class Jarvis {
 public:
  ...
  static std::vector<Point> makeHullStd(const std::list<Point>& in);
  static void makeHullStdSubRoutine(const std::list<Point>& in, std::vector<Point>* out,
...
#endif  // MODULES_TASK_4_CHESNOKOV_A_JARVIS_JARVIS_H_
