...
#ifndef MODULES_TASK_2_CHESNOKOV_A_JARVIS_JARVIS_H_
#define MODULES_TASK_2_CHESNOKOV_A_JARVIS_JARVIS_H_
...
class Jarvis {
 public:
  ...
  static std::vector<Point> makeHullOmp(std::list<Point> in);
...
#endif  // MODULES_TASK_2_CHESNOKOV_A_JARVIS_JARVIS_H_
