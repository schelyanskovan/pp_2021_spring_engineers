...
TEST(MatrixCCSMultiplication, ThrowIfNotCorrespondingMatrices) {
    ...
    MatrixCCS B = MatrixCCS(2, 4,
        ...
        {7, 0}, {0, 0},
        {0, -10}, {20, 0} });
    ASSERT_ANY_THROW(OMPMultiplication(A, B));
}
...
TEST(MatrixCCSMultiplication, CanMultiplyCorrespondingMatrices) {
    ...
    MatrixCCS B = MatrixCCS(2, 3,
        ...
        {2, 3}, {-7, 0},
        {7, 0}, {0, 0} });
    ASSERT_NO_THROW(OMPMultiplication(A, B));
}
...
TEST(MatrixCCSMultiplication, MyltiplyNumbers) {
    ...
    MatrixCCS AB = MatrixCCS(1, 1,
        { {12520, 4620} });
    ASSERT_EQ(AB, OMPMultiplication(A, B));
}
...
TEST(MatrixCCSMultiplication, MyltiplyOnSingularMatrix) {
    ...
    MatrixCCS B = MatrixCCS(2, 2,
        { {3, 20}, {4, 0},
        {0, -3}, {0, 0} });
    ASSERT_EQ(B, OMPMultiplication(A, B));
}
...
TEST(MatrixCCSCompareRealizations, CompareLeftRow) {
    ...
    A.FillRandom();
    B.FillRandom();
    ASSERT_EQ(SeqMultiplication(A, B), OMPMultiplication(A, B));
}
...
// // }
// TEST(MatrixCCSPerformance, OMP1Thread) {
...
//     std::cout << "[     TIME ] " << end - start << "\tseconds\n";
// }
// TEST(MatrixCCSPerformance, OMP2Thread) {
//     MatrixCCS A = MatrixCCS(4000, 4000, 1000000);
//     MatrixCCS B = MatrixCCS(4000, 4000, 1000000);
//     A.FillRandom();
//     B.FillRandom();
...
//     std::cout << "[     TIME ] " << end - start << "\tseconds\n";
// }
// TEST(MatrixCCSPerformance, OMP4Thread) {
//     MatrixCCS A = MatrixCCS(4000, 4000, 1000000);
//     MatrixCCS B = MatrixCCS(4000, 4000, 1000000);
//     A.FillRandom();
//     B.FillRandom();
...
//     std::cout << "[     TIME ] " << end - start << "\tseconds\n";
// }
// TEST(MatrixCCSPerformance, OMP9Thread) {
//     MatrixCCS A = MatrixCCS(4000, 4000, 1000000);
//     MatrixCCS B = MatrixCCS(4000, 4000, 1000000);
//     A.FillRandom();
//     B.FillRandom();
